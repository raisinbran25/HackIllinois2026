...
// ---- Shader sources (module-level constants — never recreated) ----
...
const FS_SOURCE = `
  ...
  void main() {
    ...
    vec4 lines = vec4(0.0);
    vec4 bgColor1 = vec4(0.04, 0.0, 0.12, 1.0);
    vec4 bgColor2 = vec4(0.1, 0.03, 0.22, 1.0);
...
export default function ShaderBackground({
  ...
  useEffect(() => {
    ...
    const program = initShaderProgram(VS_SOURCE, FS_SOURCE);
    if (!program) return;
